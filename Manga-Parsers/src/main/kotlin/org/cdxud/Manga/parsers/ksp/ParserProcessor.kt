package org.cdxud.Manga.parsers.ksp
...
class ParserProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("org.cdxud.Manga.parsers.MangaSourceParser")
        ...
        val factoryFile =
            try {
                codeGenerator.createNewFile(
                    ...
                    packageName = "org.cdxud.Manga.parsers",
        ...
        val sourcesFile =
            try {
                codeGenerator.createNewFile(
                    dependencies = dependencies,
                    packageName = "org.cdxud.Manga.parsers.model",
    ...
    private fun writeContent(
        ...
        factoryWriter?.write(
			...
			import org.cdxud.Manga.parsers.core.MangaParserWrapper
